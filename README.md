...
### Setup
1.  **Launch the App**: Open the application in your browser (e.g., `http://localhost:5173`).
2.  **Authenticate Spotify**: Click "Connect Spotify" to log in and authorize Spotibot to read your playback state.
3.  **Configure SwitchBot**:
    *   Click the "Settings" (Gear) icon.
    *   Enter your SwitchBot `Token` and `Secret`.
    *   Select the devices you want to control from the detected list.
4.  **Enjoy**: Start playing music on Spotify. The interface will come alive, and if Auto-Sync is on, your room will instantly react to your music.
